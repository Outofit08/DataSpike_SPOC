...
class DataSpikeUiApp:
    def __init__(self, master):
        ...
        self.sherlock_button.configure(style='Toolbutton', text='Search')
        self.sherlock_button.grid(column='3', padx='10', row='0')

        self.instaloader = ttk.Label(self.main_window)
        self.instaloader.configure(justify='left', padding='10', text='instaloader(username)')
        ...
        self.insta_button.configure(style='Toolbutton', text='Search')
        self.insta_button.grid(column='3', padx='10', pady='10', row='1')

        self.twint = ttk.Label(self.main_window)
        self.twint.configure(justify='left', padding='10', text='twint(username)')
        ...
        self.twint_button.configure(style='Toolbutton', text='Search')
    ...
    def execute_instaSearch(self):
        ...
        varSource = "instaloader target[" +input_name+"]"
        os.system(varSource)
